...
complete -c iptables -s X -l delete-chain -d 'Delete the chain specified.   There must be no references to the chain'
...
complete -c iptables -s V -l version -d 'Show program version and the kernel API used'
