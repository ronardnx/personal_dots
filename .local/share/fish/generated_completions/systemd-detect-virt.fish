...
complete -c systemd-detect-virt -l cvm -d 'Detect whether invoked in a confidential virtual machine'
...
complete -c systemd-detect-virt -l list-cvm -d 'Output all currently known and detectable confidential virtualization technol…'
