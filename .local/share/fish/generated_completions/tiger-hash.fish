...
complete -c tiger-hash -s i -l ignore-missing -d 'Ignore missing files, while verifying a hash file'
complete -c tiger-hash -l ignore-case -d 'Ignore case of filenames when updating crc files'
