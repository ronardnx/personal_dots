...
complete -c gzip -s N -l name -d 'When compressing, always save the original file name, and save the seconds pa…'
...
complete -c gzip -s t -l test -d 'Test.  Check the compressed file integrity then quit'
...
complete -c gzip -s '#' -l fast -l best -d 'Regulate the speed of compression using the specified digit  # , where  -1 or…'
