...
complete -c ps -s P -d 'Add a column showing psr'
...
complete -c ps -s D -d 'Set the date format of the lstart field to format'
complete -c ps -l date-format -d 'Identical to -D'
...
complete -c ps -s T -d 'Show threads, possibly with SPID column.  OTHER INFORMATION'
