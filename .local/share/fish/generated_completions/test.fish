...
complete -c test -s r -d 'FILE exists and the user has read access'
...
complete -c test -s w -d 'FILE exists and the user has write access'
complete -c test -s x -d 'FILE exists and the user has execute (or search) access'
