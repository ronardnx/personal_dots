...
complete -c pgrep -l cgroup -d 'Match on provided control group (cgroup) v2 name.  See  cgroups (8)'
...
complete -c pgrep -s q -l queue -d 'Use  sigqueue (3) rather than  kill (2) and the value argument is used to spe…'
