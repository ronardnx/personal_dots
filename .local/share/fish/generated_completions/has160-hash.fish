...
complete -c has160-hash -s i -l ignore-missing -d 'Ignore missing files, while verifying a hash file'
complete -c has160-hash -l ignore-case -d 'Ignore case of filenames when updating crc files'
